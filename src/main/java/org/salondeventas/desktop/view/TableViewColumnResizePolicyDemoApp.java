...
public class TableViewColumnResizePolicyDemoApp extends VBox {
	...
	public void configureTable() {
		...
		this.setSpacing(15);
		this.getChildren().addAll(LabelBuilder.create().text("CONSTRAINED_RESIZE_POLICY").style("-fx-font-weight:bold;").build(),table1,
